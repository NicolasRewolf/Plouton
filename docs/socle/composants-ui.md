...
La carte d'article canonique est **`AffaireCard`** (`site/src/components/AffaireCard.tsx`) — il n'y en a pas d'autre. Son ancien wrapper a été supprimé le 2026-07-19 (PR #63).
